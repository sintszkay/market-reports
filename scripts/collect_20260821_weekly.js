...
const BASELINE = JSON.parse(fs.readFileSync(path.join(ROOT, "data", "2026-08-14-weekly-longbridge.json"), "utf8"));
const OUTPUT = path.join(
  ROOT,
  "data",
  ADJUST === "forward"
    ? "2026-08-21-weekly-longbridge-adjusted.json"
    : "2026-08-21-weekly-longbridge.json"
);
