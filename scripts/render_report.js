...
if (reportType === "postmarket") {
  Object.assign(rendered, {
    ...
    sector_chart: postmarketVisuals.renderSectorChart(data.thematic_rows || data.sector_rows),
    sector_rows: postmarketVisuals.renderSectorRows(data.sector_rows),
    thematic_rows: postmarketVisuals.renderSectorRows(data.thematic_rows || []),
